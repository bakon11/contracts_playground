...
const runSpendVestingUTxO = async () => {
    ...
    spendVestingUtxoTx(protocolParameters, inputUtxos, utxOutputs, changeAddress, addressRootKeySigner, metadata, script, scriptAddress, scriptInputs, vestingAddressPKH);
};
